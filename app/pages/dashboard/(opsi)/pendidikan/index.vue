<script setup lang="ts">
  ...
  onMounted(() => {
    defineTopbarTitle("Pendidikan");
  });

  const { data, status, refresh } = await useLazyFetch("/api/pendidikan");
  ...
  <main>
    ...
    >
      <UForm
        ...
        @submit="onSubmit"
      >
        <UFormGroup label="Nama Pendidikan" name="name">
